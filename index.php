...
<header class="wrapper px-0 md:px-7.5 lg:px-12.5 h-[90px] md:h-[70px] lg:h-[100px] flex items-end mb-5 lg:mb-10">
  <div class="container !py-0 flex flex-col md:flex-row gap-5 lg:gap-10 justify-center md:justify-between items-center">
    <div class="flex gap-x-5 lg:gap-x-10 items-center">
      <a href="https://www.mos.ru/dpir/" target="_blank"><img class="h-[25px] md:h-[30px] lg:h-[40px] xl:h-[45px]" src="./img/dpir.svg" alt=""></a>
      <a href="/" target="_blank"><img class="h-[20px] md:h-[25px] lg:h-[27px] xl:h-[30px]" src="./img/mec.svg" alt=""></a>
      <a class="xl:hidden" href="https://mnp2023.ru/?utm_source=mec&utm_medium=sait_glavnaya&utm_campaign=mnp" target="_blank"><img class="h-[15px] md:h-[20px] lg:h-[23px] xl:h-[25px]" src="./img/mnp-new.svg" alt=""></a>
      <a class="hidden xl:block" href="https://mnp2023.ru/?utm_source=mec&utm_medium=sait_glavnaya&utm_campaign=mnp" target="_blank"><img class="h-[15px] md:h-[20px] lg:h-[23px] xl:h-[25px]" src="./img/mnp-full.svg" alt=""></a>
    </div>
...
<section class="wrapper mb-5 md:mb-7.5 lg:mb-10">
  <div class="container border border-primary bg-[url(../img/top-banner.jpg)] bg-[length:40%_auto] bg-right-top bg-no-repeat">
...
<section class="wrapper mb-5 md:mb-7.5 lg:mb-10 overflow-hidden">
  <div class="container overflow-visible p-0">
    <div class="relative flex flex-col md:flex-row primary-bg z-10 rounded-[40px]">
      <div class="flex items-end md:w-[50%] pt-40 pb-10 md:py-20 px-7.5 lg:px-12.5 mb-0 bg-[url(../img/why-bg.jpg)] bg-cover bg-top rounded-[40px] overflow-hidden">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
      <div class="flex items-center gap-5">
        <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M6.00049 66H66.0005" stroke="#FF2C7E" stroke-width="4.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M51.0005 6H21.0005C12.0005 6 9.00049 11.37 9.00049 18V66H63.0005V18C63.0005 11.37 60.0005 6 51.0005 6Z" stroke="#FF2C7E" stroke-width="4.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
          <path opacity="0.4" d="M42.1811 45H29.7912C28.2612 45 26.9712 46.26 26.9712 47.82V66H44.9711V47.82C45.0011 46.26 43.7411 45 42.1811 45Z" stroke="#FF2C7E" stroke-width="4.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
          <g opacity="0.4">
            <path d="M36.0005 18V33" stroke="#FF2C7E" stroke-width="4.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M28.5005 25.5H43.5005" stroke="#FF2C7E" stroke-width="4.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
          </g>
        </svg>
      ...
      <div class="flex items-center gap-5">
        <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M42.6587 29.34L35.9987 32.67M35.9987 32.67L29.3386 29.34M35.9987 32.67V41.01M42.6587 9.33L35.9987 6L29.3386 9.33M15.9886 56.01L9.32861 52.68V44.34M56.0087 56.01L62.6687 52.68V44.34" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <g opacity="0.4">
            <path d="M62.6703 20.729L56.0103 24.059" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M62.6703 20.7294L56.0103 17.3994" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M62.6724 20.729V29.069" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M9.32861 20.7294L15.9886 17.3994" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M9.32861 20.729L15.9886 24.059" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M9.32861 20.729V29.069" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M35.9984 67.4096L29.3384 64.0796" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M36.0005 67.4096L42.6605 64.0796" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M36.0005 67.4098V59.0698" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          </g>
        </svg>
      ...
      <div class="flex items-center gap-5">
        <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clip-path="url(#clip0_6992_10289)">
            <path d="M48.9954 26.1818C48.9954 38.8472 38.7518 49.0909 26.0863 49.0909C25.0391 49.0909 24.0245 49.0254 23.0427 48.8618C11.8172 47.3891 3.17725 37.8 3.17725 26.1818C3.17725 13.5163 13.4209 3.27271 26.0863 3.27271C37.7045 3.27271 47.2936 11.9127 48.7663 23.1382C48.93 24.12 48.9954 25.1345 48.9954 26.1818Z" stroke="#FF2C7E" stroke-width="4.36364" stroke-linecap="round" stroke-linejoin="round" />
            <path opacity="0.4" d="M68.633 45.8176C68.633 58.4831 58.3893 68.7267 45.7239 68.7267C34.1057 68.7267 24.5167 60.0867 23.0439 48.8613C24.0258 49.0249 25.0403 49.0904 26.0876 49.0904C38.753 49.0904 48.9966 38.8467 48.9966 26.1813C48.9966 25.1341 48.9312 24.1195 48.7675 23.1377C59.993 24.6104 68.633 34.1994 68.633 45.8176Z" stroke="#FF2C7E" stroke-width="4.36364" stroke-linecap="round" stroke-linejoin="round" />
            <path opacity="0.4" d="M42.9424 42.9385L47.2297 47.1603" stroke="#FF2C7E" stroke-width="4.36364" stroke-linecap="round" stroke-linejoin="round" />
            <path opacity="0.4" d="M52.2683 36L48.9956 32.7273" stroke="#FF2C7E" stroke-width="4.36364" stroke-linecap="round" stroke-linejoin="round" />
            <path opacity="0.4" d="M35.9046 52.3635L32.6318 49.0908" stroke="#FF2C7E" stroke-width="4.36364" stroke-linecap="round" stroke-linejoin="round" />
          </g>
          <defs>
      ...
      <div class="flex items-center gap-5">
        <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M39.9005 24.3303L43.8605 32.2503C44.4005 33.3303 45.8405 34.4103 47.0405 34.5903L54.2105 35.7903C58.8005 36.5703 59.8805 39.8703 56.5805 43.1703L51.0005 48.7503C50.0705 49.6803 49.5305 51.5103 49.8305 52.8303L51.4205 59.7603C52.6805 65.2203 49.7705 67.3503 44.9405 64.5003L38.2205 60.5103C36.9905 59.7903 35.0105 59.7903 33.7805 60.5103L27.0604 64.5003C22.2304 67.3503 19.3203 65.2203 20.5803 59.7603L22.1704 52.8303C22.4704 51.5403 21.9304 49.7103 21.0004 48.7503L15.4204 43.1703C12.1204 39.8703 13.2004 36.5403 17.7904 35.7903L24.9604 34.5903C26.1604 34.3803 27.6004 33.3303 28.1404 32.2503L32.1005 24.3303C34.2305 20.0403 37.7705 20.0403 39.9005 24.3303Z" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path opacity="0.4" d="M18.0005 27V6" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path opacity="0.4" d="M54.0005 27V6" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path opacity="0.4" d="M36.0005 12V6" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        <div>Fashion-индустрия</div>
      </div>
      <div class="flex items-center gap-5">
        <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M53.3705 31.4094V53.3694C53.3705 60.3594 47.7005 65.9994 40.7405 65.9994H18.6305C11.6705 65.9994 6.00049 60.3294 6.00049 53.3694V31.4094C6.00049 24.4193 11.6705 18.7793 18.6305 18.7793H40.7405C47.7005 18.7793 53.3705 24.4493 53.3705 31.4094Z" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path opacity="0.34" d="M16.5005 12V6.75" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path opacity="0.34" d="M28.5005 12V6.75" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path opacity="0.34" d="M40.5005 12V6.75" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M65.9977 39.4806C65.9977 46.4406 60.3277 52.1106 53.3677 52.1106V26.8506C60.3277 26.8506 65.9977 32.4906 65.9977 39.4806Z" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path opacity="0.34" d="M6.00049 36H52.5305" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      ...
      <div class="flex items-center gap-5">
        <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g opacity="0.4">
            <path d="M23.4028 30.6006V43.2006" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M23.8505 29.7C27.0814 29.7 29.7005 27.0809 29.7005 23.85C29.7005 20.6192 27.0814 18 23.8505 18C20.6197 18 18.0005 20.6192 18.0005 23.85C18.0005 27.0809 20.6197 29.7 23.8505 29.7Z" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M23.4005 53.9997C26.3828 53.9997 28.8004 51.582 28.8004 48.5997C28.8004 45.6174 26.3828 43.1997 23.4005 43.1997C20.4181 43.1997 18.0005 45.6174 18.0005 48.5997C18.0005 51.582 20.4181 53.9997 23.4005 53.9997Z" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M48.6017 53.9997C51.584 53.9997 54.0017 51.582 54.0017 48.5997C54.0017 45.6174 51.584 43.1997 48.6017 43.1997C45.6194 43.1997 43.2017 45.6174 43.2017 48.5997C43.2017 51.582 45.6194 53.9997 48.6017 53.9997Z" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M23.6372 30.6006C24.4472 33.7506 27.3271 36.0906 30.7172 36.0606L36.8972 36.0306C41.6072 36.0006 45.6272 39.0306 47.0972 43.2606" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          </g>
          <path d="M27.0005 66H45.0005C60.0005 66 66.0005 60 66.0005 45V27C66.0005 12 60.0005 6 45.0005 6H27.0005C12.0005 6 6.00049 12 6.00049 27V45C6.00049 60 12.0005 66 27.0005 66Z" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        <div>Высокотехнологичная продукция</div>
      </div>
      <div class="flex items-center gap-5">
        <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M54.0005 44.9999V56.9999C54.0005 61.9499 49.9505 65.9999 45.0005 65.9999H27.0005C22.0505 65.9999 18.0005 61.9499 18.0005 56.9999V41.9399L29.6705 41.9999C31.8605 41.9999 34.0205 42.5099 36.0005 43.4999C37.9805 44.4899 40.1405 44.9999 42.3605 44.9999H54.0005Z" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path opacity="0.4" d="M54.0005 32.49V45H42.3605C40.1405 45 37.9805 44.49 36.0005 43.5C34.0205 42.51 31.8605 42 29.6705 42L18.0005 41.94V32.49C18.0005 31.11 18.7806 29.22 19.7706 28.23L26.1305 21.87C26.6705 21.33 27.0005 20.55 27.0005 19.77V15H45.0005V19.77C45.0005 20.55 45.3305 21.33 45.8705 21.87L52.2305 28.23C53.2205 29.22 54.0005 31.11 54.0005 32.49Z" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M54.0005 48V45" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M18.0005 44.9399V41.9399" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M43.5005 15H28.5005C26.0105 15 24.0005 12.96 24.0005 10.5C24.0005 8.04 26.0105 6 28.5005 6H43.5005C45.9905 6 48.0005 8.04 48.0005 10.5C48.0005 12.96 45.9905 15 43.5005 15Z" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      ...
      <div class="flex items-center gap-5">
        <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M6.00049 66H66.0005" stroke="#FF2C7E" stroke-width="4.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M8.85107 66.0009L9.00107 29.9107C9.00107 28.0807 9.87107 26.3409 11.3111 25.2009L32.3111 8.85082C34.4711 7.17082 37.5011 7.17082 39.6911 8.85082L60.6911 25.1708C62.1611 26.3108 63.0011 28.0507 63.0011 29.9107V66.0009" stroke="#FF2C7E" stroke-width="4.5" stroke-miterlimit="10" stroke-linejoin="round" />
          <path opacity="0.4" d="M46.5005 33H25.5005C23.0105 33 21.0005 35.01 21.0005 37.5V66H51.0005V37.5C51.0005 35.01 48.9905 33 46.5005 33Z" stroke="#FF2C7E" stroke-width="4.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M30.0005 48.75V53.25" stroke="#FF2C7E" stroke-width="4.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
          <path opacity="0.4" d="M31.5005 22.5H40.5005" stroke="#FF2C7E" stroke-width="4.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        <div>Строительная отрасль</div>
      </div>
      <div class="flex items-center gap-5">
        <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M30.0005 50.8494H18.6305C8.52049 50.8494 6.00049 48.3294 6.00049 38.2194V20.2194C6.00049 10.1094 8.52049 7.58936 18.6305 7.58936H50.2205C60.3305 7.58936 62.8505 10.1094 62.8505 20.2194" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M30.0005 64.4106V50.8506" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path opacity="0.4" d="M6.00049 38.8506H30.0005" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M20.2212 64.4106H30.0011" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M66.0013 38.3994V55.5294C66.0013 62.6394 64.2313 64.4094 57.1213 64.4094H46.4713C39.3613 64.4094 37.5913 62.6394 37.5913 55.5294V38.3994C37.5913 31.2894 39.3613 29.5195 46.4713 29.5195H57.1213C64.2313 29.5195 66.0013 31.2894 66.0013 38.3994Z" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path opacity="0.4" d="M51.7339 54.75H51.7615" stroke="#FF2C7E" stroke-width="6" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        <div>ИТ-продукты и услуги</div>
      </div>
      <div class="flex items-center gap-5">
        <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M38.7605 6.77953L58.2905 17.3095C60.5705 18.5395 60.5705 22.0495 58.2905 23.2795L38.7605 33.8094C37.0205 34.7394 34.9805 34.7394 33.2405 33.8094L13.7105 23.2795C11.4305 22.0495 11.4305 18.5395 13.7105 17.3095L33.2405 6.77953C34.9805 5.84953 37.0205 5.84953 38.7605 6.77953Z" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path opacity="0.4" d="M10.8305 30.3906L28.9805 39.4806C31.2305 40.6206 32.6705 42.9305 32.6705 45.4505V62.6105C32.6705 65.1005 30.0605 66.6906 27.8405 65.5806L9.69049 56.4906C7.44049 55.3506 6.00049 53.0406 6.00049 50.5206V33.3606C6.00049 30.8706 8.61049 29.2805 10.8305 30.3906Z" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path opacity="0.4" d="M61.1686 30.3906L43.0186 39.4806C40.7686 40.6206 39.3286 42.9305 39.3286 45.4505V62.6105C39.3286 65.1005 41.9386 66.6906 44.1586 65.5806L62.3086 56.4906C64.5586 55.3506 65.9986 53.0406 65.9986 50.5206V33.3606C65.9986 30.8706 63.3886 29.2805 61.1686 30.3906Z" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        <div>Мебельная промышленность</div>
      </div>
      <div class="flex items-center gap-5">
        <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M39.1799 32.8196C45.9299 39.5696 45.9299 50.4896 39.1799 57.2096C32.4299 63.9296 21.51 63.9596 14.79 57.2096C8.07003 50.4596 8.04003 39.5396 14.79 32.8196" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
          <path opacity="0.4" d="M31.7732 40.2297C24.7533 33.2097 24.7533 21.8097 31.7732 14.7597C38.7932 7.70965 50.1932 7.73965 57.2432 14.7597C64.2932 21.7797 64.2632 33.1797 57.2432 40.2297" stroke="#FF2C7E" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        <div>Оборудование</div>
      </div>
      <div class="flex items-center gap-5">
        <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M63 12C61.2 12 52.2 16.5 36 16.5C20.1 16.5 10.5 12 9 12C7.5 12 6 13.2 6 15V57C6 58.8 7.5 60 9 60C10.8 60 19.5 55.5 36 55.5C52.2 55.5 61.2 60 63 60C64.5 60 66 58.8 66 57V15C66 13.2 64.5 12 63 12ZM61 53.8C55 52 46.2 50.5 36 50.5C25.8 50.5 17 52 11 53.8V18.2C18.8 20.3 27.9 21.5 36 21.5C46.2 21.5 55 20 61 18.2V53.8Z" fill="#FF2C7E" />
          <g opacity="0.4">
            <path d="M16.5 46.2L27.6 33L33.6 40.2L42 30L55.5 46.2C49.5 45.3 42.9 45 36 45C29.1 45 22.5 45.3 16.5 46.2Z" fill="#FF2C7E" />
          </g>
        </svg>
        <div>Креативные индустрии</div>
      </div>
    </div>
    <div class="absolute top-1/2 right-full -translate-x-[1px] lg:-translate-x-[15px] -translate-y-1/2 z-0 w-[52px] overflow-hidden">
  ...
  <div class="container p-0 text-white font-bold overflow-visible">
    <div class="relative z-10">
      ...
      <div class="md:flex md:gap-2.5 space-y-2.5 md:space-y-0">
        ...
        <div class="flex-1 h3 mb-0 bg-[url(../img/digest-bg.jpg)] bg-cover bg-top h-0 md:h-auto pb-[75%] md:py-7.5 lg:py-10 px-7.5 lg:px-12.5 rounded-[40px] overflow-hidden">
        </div>
      </div>
    </div>
    <img class="absolute top-0 left-full -translate-x-1/2 translate-y-1/3 z-0 w-[100px] lg:w-[158px]" src="./img/x.svg" alt="">
  </div>
</section>
<!-- Конец блока -->
<!-- Начало блока -->
...
<section id="events" class="wrapper mb-5 md:mb-7.5 lg:mb-10 overflow-hidden">
  <div class="container overflow-visible">
    <div class="relative z-10">
      ...
      <div class="events-switcher">
        <div class="events-tabs flex flex-col md:flex-row border border-secondary rounded-[20px] md:rounded-full">
          <div class="events-btn flex items-center justify-center grow py-2.5 md:py-5 px-5 rounded-full text-center cursor-pointer bg-primary text-white" data-target="events-3">PRO-экспорт
          </div>
          <div class="events-btn flex items-center justify-center grow py-2.5 md:py-5 px-5 rounded-full text-center cursor-pointer" data-target="events-1">
            Карта твоего экспорта
          </div>
          <div class="events-btn flex items-center justify-center grow py-2.5 md:py-5 px-5 rounded-full text-center cursor-pointer" data-target="events-2">Экспортируй прямо сейчас
          </div>
          <div class="events-btn flex items-center justify-center grow py-2.5 md:py-5 px-5 rounded-full text-center cursor-pointer" data-target="events-4">Meeting Buyers
          </div>
        </div>
        <div class="events-blocks mt-5">
          <div class="events-block" data-switcher-block="events-3">
            ...
            <div class="flex flex-col md:flex-row gap-y-2.5 gap-x-15 py-5 md:py-10 md:px-7.5 lg:px-12.5 border-b border-primary">
              <div class="min-w-[120px]">11.00-12.00</div>
              <div>
                <div class="switcher-link font-bold text-primary cursor-pointer hover:underline underline-offset-4 decoration-1">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
                    ...
                    <div class="flex gap-5 items-start">
                      ...
                      <div class="text-small">
                        ...
                        <div>Генеральный директор ООО «Цифровые платежи» (крипта)</div>
                      </div>
                    </div>
                    <div class="flex gap-5 items-start">
    ...
    <img class="absolute top-0 left-full translate-x-[1px] lg:translate-x-[15px] translate-y-2/3 z-0 w-[70px] lg:w-[85px]" src="./img/xxx.svg" alt="">
    <img class="absolute top-1/2 right-full translate-x-[15px] -translate-y-1/2 z-0 w-[200px] lg:w-[289px]" src="./img/circle-01.svg" alt="">
...
<section id="request" class="wrapper mb-5 md:mb-7.5 lg:mb-10 overflow-hidden">
  <div class="container border border-primary overflow-visible">
    ...
    <div class="absolute top-0 right-full -translate-x-[10px] lg:-translate-x-[15px] translate-y-1/3 z-0 w-[70px] lg:w-[85px] h-[75px] lg:h-[90px] overflow-hidden">
      <img class="w-[70px] lg:w-[85px] max-w-none" src="./img/xxx.svg" alt="">
    </div>
  </div>
</section>
...
<section class="wrapper mb-5 md:mb-7.5 lg:mb-10 overflow-visible">
  <div class="container flex flex-col md:flex-row border border-primary p-0">
    ...
    <div class="flex items-end md:w-[50%] h-0 md:h-auto pb-[66.666%] md:pb-0 bg-[url(../img/scheme-bg.jpg)] bg-cover bg-top rounded-[40px] overflow-hidden">
    </div>
  </div>
</section>
<!-- Конец блока -->
  ...
  <div class="container border border-primary">
    <div class="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-x-5 gap-y-5 md:gap-y-10 items-center">
      ...
      <div class="rounded-[20px] md:rounded-[40px] overflow-hidden">
        <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A7ab5ae915b6826376295ece38bcf1ebd03d26da71de3acedaf6e0cd6cafd331d&amp;source=constructor" width="100%" height="400" frameborder="0"></iframe>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="flex flex-col lg:flex-row gap-x-7.5 gap-y-5 items-center pb-7.5 border-b border-[#F3F3F3]">
      <div class="flex flex-col md:flex-row gap-x-7.5 gap-y-5 items-center">
        <div class="min-w-max"><a class="font-bold hover:text-[#F3F3F3]" href="tel:+74992888501">+7 (499)
            288-85-01</a></div>
        <div class="min-w-max"><a class="font-bold hover:text-[#F3F3F3]" href="mailto:info@moscow-export.ru">info@moscow-export.ru</a></div>
      </div>
